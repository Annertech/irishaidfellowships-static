 ...
 * Project: Department of Foreign Affairs - Feature Landing page
 * Version: 0.1.0
 * Description: Create a feature landing page for use in various DFA sites
 * Copyright 2017
 * Created by Michael Mason/Joe Crilly
...
var Lightbox = (function ($) {
	...
	var Default = {
		...
		leftArrow: '<span>â®</span>',
		rightArrow: '<span>â¯</span>',
		strings: {
			close: 'Close',
    ...
    _padding / _border: CSS properties for the modal container; these are used to calculate the available space for the content
   	 */
		...
		function Lightbox($element, config) {
			...
			var header = '<div class="modal-header"' + (this._config.title || this._config.alwaysShowClose ? '' : ' style="display:none"') + '><button type="button" class="close" data-dismiss="modal" aria-label="' + this._config.strings.close + '"><span aria-hidden="true" class="fa fa-close"></span></button><h4 class="modal-title">' + (this._config.title || " ") + '</h4></div>';
		...
		_createClass(Lightbox, [{
			...
			value: function _showYoutubeVideo(remote, $containerForElement) {
				...
				var width = this._$element.data('width') || 1200;
				var height = this._$element.data('height') || width / (1200 / 670);
				return this._showVideoIframe('//www.youtube-nocookie.com/embed/' + id + '?badge=0&rel=0&autoplay=1&mute=1' + query, width, height, $containerForElement);
			}
		}, {
			key: '_showVimeoVideo',
...
(function t4mainfunction($global) { 
    ...
    */
    ...
    $ajax.open('GET', '/media/dfa-2017/style-assets/media/svg-stack/dfa-icons-2019-update.svg', true);
...
//            $('.panel-collapse').eq(0).collapse('show'); 
    ...
    if($('.security-status').length != 0 && jQuery('body#en-lang').length != 0 && jQuery('.updated-date').length != 0) {
		...
		var todays_full_date = "23 November 2023"; //today_date + " " + today_month + " " + today_year;
    ...
    $( document ).ready(function() {
      $('div.table-responsive table').addClass('table');
    });
  
    //Fix Fulltext next/Previous and repeat article
    $( document ).ready(function() {
      if ($('.press-release p.prev-next span').length > 1) {
      } else {
          $('.press-release p.prev-next span').hide();
      }
      var article = $('.content--fulltext').attr('data-article-id');
      $( ".related_news .news-listing-entry" ).each(function( index ) {
        if ($(this).attr('data-article-id') === article) {
          $(this).remove();
        }
      });  
    });
    ...
    $( document ).ready(function() {
      if (!$( ".related_news .news-listing-entry" ).length) {
        $('.related_news .landing-feature--news-listing__list h3').remove();
      }
    });
    $(document).ready(function(){
      setTimeout(function(){
        $(".funnelback-search a.dropdown-item").each(function() {
            this.href = this.href.replace('search.html', 'search.php');
        });
        $(".funnelback-search #search-spelling em a").each(function() {
            this.href = this.href.replace('search.html', 'search.php');
        });
      }, 500);  
    });
    ...
    function ieLogos() {
        var logos  = $('.dfa-partner-logos__item').length;
        if (logos == 6) {
            $('.dfa-partner-logos__item').css('width', '16%');
        } else if (logos == 5) {
            $('.dfa-partner-logos__item').css('width', '20%');
        } else if (logos == 4) {
            $('.dfa-partner-logos__item').css('width', '25%');
        } else if (logos == 3) {
            $('.dfa-partner-logos__item').css('width', '33%');
        } else if (logos == 2) {
            $('.dfa-partner-logos__item').css('width', '50%');
        } else if (logos == 1) {
            $('.dfa-partner-logos__item').css('width', '100%');
        }
    }
    ...
    $('.search-button.dfa-icon').on('click', function(e){
        e.preventDefault();
        $('#dfa-site-search').submit();
    });
    
    function twitterLink() {
        var handle = $('.info-card__address__misc h3').text();
        var newHandle = handle.split('@').pop();
    
        $('.info-card__address__misc h3').wrapInner('<a href="https://twitter.com/'+newHandle+'" target="_blank"></a>');
    }

    if($('.info-card__address__misc h3').length) {
        twitterLink();
    }
  
    $('.footer-links-col span.heading').on('click', function() {
        $(this).parent().find('ul').toggleClass('open');
    });
    
    $('.footer-large').each(function() {
        var columnLength = $(this).find('.footer-links-col, .footer-links-colfirst').length;
        if (columnLength === 2) {
            $(this).find('.footer-links-col, .footer-links-colfirst').addClass('two-cols');
            console.log(columnLength);
        }
        if (columnLength === 3) {
            $(this).find('.footer-links-col, .footer-links-colfirst').addClass('three-cols');
            console.log(columnLength);
        }
        if (columnLength === 4) {
            $(this).find('.footer-links-col, .footer-links-colfirst').addClass('four-cols');
            console.log(columnLength);
        }
        $('.footer-large .footer-links-col:nth-child(2n)').not('.first').after('<div class="footer-clearfix"></div>');
    });
  
    var ua = navigator.userAgent.toLowerCase();
    var isAndroid = ua.indexOf("android") > -1; //&& ua.indexOf("mobile");
    if(isAndroid) { 
       $('.dfa-card.dfa-card--horizontal .dfa-svg-icon').each(function( key, value ) {
          $(this).addClass('android');
        }); 
    }
    
  /*Travel Accordion Tabs*/
    
  /*Hide single breadcrumb*/
  var listCount = $('.inner-page-breadcrumbs__nav li').length;

  if (listCount === 1) {
      $('.inner-page-breadcrumbs__nav').hide();
  }
  var listCountLanding = $('.breadcrumbs__nav li').length;

  if (listCountLanding === 1) {
      $('.breadcrumbs__nav').hide();
  }
  
  /*Remove Tab Breadcrumbs*/
  var tabArray = ["discovery_tab_body_1","discovery_tab_body_2","discovery_tab_body_3","discovery_tab_body_4","discovery_tab_body_5"];
  
  $('.inner-page-breadcrumbs__nav li').each(function() {
    var linkText = $(this).find('a').text();
    var listText = $(this).text();
    
    if ((jQuery.inArray(linkText, tabArray)!='-1') || (jQuery.inArray(listText, tabArray)!='-1')) {
        $(this).next('span.breadcrumb_separator').remove();
        $(this).remove();
    }
  ...
  /*Hide Extra Flags - Travel Advice*/
  if (window.location.href.indexOf("SiteManager?ctfn") > -1) {
	var flagImageSrc1 = $('.travel-flag img').attr('alt');

	var flagImageSrc2 = $('.side-bar__content .sidebar-image img').attr('alt');

	var flagImageSrc3 = $('.side-bar__content__mobile .sidebar-image img').attr('alt');
	
	if (flagImageSrc1 === flagImageSrc2) {
	    $('.side-bar__content .sidebar-image').remove();
	}
	
	if (flagImageSrc1 === flagImageSrc3) {
	    $('.side-bar__content__mobile .sidebar-image').remove();
	}
  } else {
      var flagImageSrc1 = $('.travel-flag img').attr('src');
  
      var flagImageSrc2 = $('.side-bar__content .sidebar-image img').attr('src');
  
      var flagImageSrc3 = $('.side-bar__content__mobile .sidebar-image img').attr('src');
  ...
  var monthslist = $('.archive-subsections.months ul');
  var monthslistItems = monthslist.children('li');
  monthslist.append(monthslistItems.get().reverse());
  
  if (window.location.href.indexOf("https://www.dfa.ie/ie/") > -1) {
    $('span.desktop-search-text').text('Cuardaigh:');
  }
  $( document ).ready(function() {						
  ...
  $( document ).ready(function() {
    $('li.main-nav-list__dropdown').each(function(){
      $(this).on('click', function(){
          $(this).toggleClass('main-nav--hover');
      });
    });
    $(window).resize(function() {
        ...
        if (width > 991) {
            setTimeout(function(){
                $('li.main-nav-list__dropdown').removeClass('main-nav--hover');
            }, 50);
        }
    });
  });
...
if ($('.hero-slider').length != 0) {
  $('.hero-slider .slides').slick({
    ...
    autoplay: true,
    speed: 500,
    prevArrow: '<svg class="dfa-svg-icon"><use xlink:href="#circle_right"></use></svg>',
    nextArrow: '<svg class="dfa-svg-icon"><use xlink:href="#circle_right"></use></svg>',
    appendArrows: '.hero-slider-controls .content-wrap',
    slidesToShow: 1
  }); 
}
if ($('.job-app-listing').length) { 
    $('.no-vacancies').remove();
}
if ($('.job-app-listing').length === 0) { 
    $('.no-vacancies').not(':first').remove();
}
                                                                                                                                                                                                                     $("a.skip-main").on('click', function(event) {
  if (this.hash !== "") {
    event.preventDefault();
    var hash = this.hash;
    $('html, body').animate({
...
$(".news-anchors a").on('click', function(event) {
  if (this.hash !== "") {
    event.preventDefault();
    var hash = this.hash;
    $('html, body').animate({
...
var langArray2 = ["Current transit visa fee:"];  
  $('.pl .change-lang strong').each(function() {
    var langLinkText = $(this).text();  
    if (jQuery.inArray(langLinkText, langArray2)!='-1') {
      $(this).text('Opłata za wizę tranzytową:');
  }
});
$(window).resize(function() {
    if ($(window).width() > 1199) {
		var tabID = $('.accordion-tabs__tabs__item.active').attr('rel');
		var hashedID = '#'+tabID
		$(hashedID).addClass('active');
		$(hashedID).show();
	}
});
$('iframe[src*="issuu"]').each(function() {
    $(this).addClass('issuu-iframe')
}); 
$( document ).ready(function() {
  $('p.media-iframe').each(function() {
    var dataSource = $(this).data('youtube-url');
    var dataSourceSplit = dataSource.split('?v=');
    var iframe = '<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/'+dataSourceSplit[1]+'?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
    $(this).append(iframe);
  });
  $('.travel-buttons-country').matchHeight();
});
$(document).ready(function(){
  if($('#servisbot-app').length) {
    $('#return-to-top').addClass('move-left');
  }
  if(window.location.href.indexOf('/es/') > -1) {
    $('.no-vacancies h2').text('Por el momento no hay vacantes disponsibles.');
  }
  $('.discovery-slider__controls_prev').attr('tabindex','0');
  $('.discovery-slider__controls__pause').attr('tabindex','0');
  $('.discovery-slider__controls_next').attr('tabindex','0');

  $('.discovery-slider__controls_prev').keypress(function (e) {
   var key = e.which;
   if(key == 13)  // the enter key code
    {
      $('.discovery-slider__controls_prev').click();
      return false;  
    }
  });
  $('.discovery-slider__controls__pause').keypress(function (e) {
   var key = e.which;
   if(key == 13)  // the enter key code
    {
      $('.discovery-slider__controls__pause').click();
      return false;  
    }
  });
  $('.discovery-slider__controls_next').keypress(function (e) {
   var key = e.which;
   if(key == 13)  // the enter key code
    {
      $('.discovery-slider__controls_next').click();
      return false;  
    }
  });
  $('.footer-links-list').append('<li><a href="https://www.ireland.ie/">Ireland.ie</a></li>');
  $('.three-column--column').matchHeight();
  if (window.location.href.indexOf("dfa.ie/ie/") > -1) {
    $('div.search-link a').text('Naisc tapa');
  }
  if (window.location.href.indexOf("irishaid.ie/ie/") > -1) {
    $('div.search-link a').text('Naisc tapa');
  }
});